"""
FullyCollective (Optimized stack), semantic-action-level, cramped_room.
...
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesOptimized import utils as dyn_utils
...
def run_agent_vs_env_scenarios():
    ...
    try:
        from agents.FullyCollectiveFixedPoliciesOptimized.agent import Agent
