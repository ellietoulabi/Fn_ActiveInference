...
from agents.IndividuallyCollectiveActiveInferenceWithDynamicPolicies import utils as dyn_utils
...
def run_agent_vs_env_scenarios():
    ...
    try:
        from agents.ActiveInferenceFixedPoliciesPreSessionFixes.agent import Agent
