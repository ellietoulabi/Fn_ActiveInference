"""
FullyCollective (base/unoptimized stack), semantic-action-level, cramped_room.
...
from agents.FullyCollectiveActiveInferenceWithDynamicPolicies import utils as dyn_utils
...
def run_agent_vs_env_scenarios():
    ...
    try:
        from agents.FullyCollectiveFixedPolicies.agent import Agent
