...
run_fully_collective_policy_semantic_action_level_optimized_lengthnorm.py.
...
import run_fully_collective_policy_semantic_action_level_optimized_lengthnorm as ric
