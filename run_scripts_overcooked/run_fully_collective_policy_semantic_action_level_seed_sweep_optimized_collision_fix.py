...
run_fully_collective_policy_semantic_action_level_optimized_collision_fix.py.
...
import run_fully_collective_policy_semantic_action_level_optimized_collision_fix as ric
