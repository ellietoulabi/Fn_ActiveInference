"""
FullyCollective (Optimized + LengthNorm stack -- PAUSED/experimental, see ai/02-debug.md), semantic-action-level, cramped_room.
...
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesOptimizedLengthNorm import utils as dyn_utils
...
def run_agent_vs_env_scenarios():
    ...
    try:
        from agents.FullyCollectiveFixedPoliciesOptimizedLengthNorm.agent import Agent
