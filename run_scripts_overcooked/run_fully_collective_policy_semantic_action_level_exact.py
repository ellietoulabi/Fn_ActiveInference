"""
FullyCollective (Exact per-factor decomposition stack), semantic-action-level, cramped_room.
...
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesExact import utils as dyn_utils
