...
def main():
    ...
    parser = argparse.ArgumentParser(description='Compare 8 agents on RedBlueButton environment')
    ...
    csv_filename = f"eight_agents_comparison_ep{NUM_EPISODES}_step{MAX_STEPS}_seed{seed_idx}_{timestamp}.csv"
