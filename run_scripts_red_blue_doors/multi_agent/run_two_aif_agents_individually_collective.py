...
def main():
    ...
    csv_filename = f"two_aif_agents_individually_collective_{SEED_TAG}_ep{NUM_EPISODES_PER_SEED}_step{MAX_STEPS}_redblue_{timestamp}.csv"
    ...
    if args.log_policy_beliefs:
        jsonl_filename = f"two_aif_agents_individually_collective_{SEED_TAG}_ep{NUM_EPISODES_PER_SEED}_step{MAX_STEPS}_redblue_{timestamp}_policy_log.jsonl"
    ...
    stats_filename = f"two_aif_agents_individually_collective_{SEED_TAG}_ep{NUM_EPISODES_PER_SEED}_step{MAX_STEPS}_redblue_{timestamp}_stats.json"
