...
def B_fn(qs, action, width, height, B_NOISE_LEVEL=0.0):
    # Movement noise zeroed (was 0.05), matching the 2026-08-13 MA Independent
    # noise redesign (ai/02-debug.md) -- movement in this environment is
    # actually 100% deterministic, so this removes a residual, unintended
    # source of predicted-position entropy that the old adaptive-threshold
    # control.py was implicitly relying on for policy differentiation once
    # belief about the task's core structure (button location) is certain.
    new_qs = {}
