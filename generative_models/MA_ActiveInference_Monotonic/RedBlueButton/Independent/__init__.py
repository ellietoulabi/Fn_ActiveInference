...
Implementation note:
We reuse the SA RedBlueButton A/B/C/D/model_init, and provide an `env_utils` adapter
that converts TwoAgentRedBlueButton observations into SA-format observations per agent.
"""
