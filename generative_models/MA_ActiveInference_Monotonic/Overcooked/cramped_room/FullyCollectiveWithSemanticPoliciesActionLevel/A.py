# A.py
"""
Observation likelihoods p(o | state) model (A) for FullyCollective paradigm — Cramped Room.

Structurally identical to the IC observation model: the single IC brain
observes the global self / other / pot / counters / delivered modalities and
A_fn returns per-modality categorical likelihoods.
