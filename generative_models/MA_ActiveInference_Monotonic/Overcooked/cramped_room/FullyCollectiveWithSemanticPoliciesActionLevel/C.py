# C.py
"""
Preference model (C) for FullyCollective paradigm — Cramped Room (sparse reward).

Identical to the IC preference model: the IC brain prefers the
"soup delivered this step" event pulse.
"""
