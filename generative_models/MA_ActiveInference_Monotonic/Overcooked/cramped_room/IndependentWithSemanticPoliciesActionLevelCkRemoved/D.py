...
# computation in ai/02-debug.md section I.1 (never observed, never eligible
# for info gain, never read by anything else in the model, including each
# other or ck_delivered). ck_delivered is kept: it is the sole link between
# "the agent just delivered" and C_fn's only nonzero preference.
CHECKBOX_FACTORS = ("ck_delivered",)
