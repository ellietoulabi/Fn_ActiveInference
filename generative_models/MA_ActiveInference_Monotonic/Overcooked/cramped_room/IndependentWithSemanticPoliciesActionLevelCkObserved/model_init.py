...
observations = {
    ...
    # v2 (CkObserved) only: direct observations of the recipe-progress
    # checkboxes, added specifically to test whether giving them their own
    # observation channel (closing the structural gap documented in
    # ai/02-debug.md section I.1) changes behavior versus v1 (unobserved,
    # current default) and v3 (removed). Ground truth derived in env_utils.py.
    "ck_put1_obs": [0, 1],
    "ck_put2_obs": [0, 1],
    "ck_put3_obs": [0, 1],
    "ck_plated_obs": [0, 1],
