...
def test_state_observation_definitions():
    ...
    assert "soup_delivered" in model_init.states, "Should have soup_delivered"
    ...
    assert len(model_init.states["soup_delivered"]) == 2, "soup_delivered should have 2 states"
    ...
    # Observations should match states for Independent paradigm
...
def test_dependencies():
    ...
    assert model_init.observation_state_dependencies["soup_delivered"] == ["soup_delivered"], \
        "soup_delivered observation should depend only on soup_delivered state"
...
def test_independent_paradigm_consistency():
    ...
    # - soup_delivered: whether they delivered soup
