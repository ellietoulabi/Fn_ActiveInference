...
- Env fully observable: front_tile_type (deterministic from pos+orientation+other_pos+layout).
- soup_delivered is OBSERVATION-ONLY (event)
...
# -------------------------------------------------
# Walls (fixed cramped-room layout)
# Layout:
#   XXPXX
#   O1  O
#   X  2X
...
# soup_delivered intentionally omitted (event obs; not generated from hidden states here)
# -------------------------------------------------
