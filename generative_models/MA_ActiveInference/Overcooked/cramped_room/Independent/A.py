# A.py
"""
Observation model (A) for Independent paradigm — Cramped Room (Stage 1).

- Known map (no map latent factor).
- Strong affordance observation: front_tile_type computed from model_init.compute_front_tile_type(...).
