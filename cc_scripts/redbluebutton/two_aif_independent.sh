...
DEST_BASE=${DEST_BASE_OVERRIDE:-"/home/toulabin/projects/def-jrwright/toulabin/logs/ma_ind_redbluebutton_step${MAX_STEPS}_30seed"}
mkdir -p "${DEST_BASE}"
...
cp logs/two_aif_agents_independent_seed${SEED_IDX}_ep*_*_configs.json "${DEST_BASE}/" 2>/dev/null || echo "Warning: configs JSON file not found"
echo "Copy done"
