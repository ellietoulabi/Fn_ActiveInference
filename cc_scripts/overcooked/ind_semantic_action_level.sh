...
#SBATCH --job-name=aif_ind_sal_alpha8_entropy_threshold1e-3
#SBATCH --array=0-9                   # 10 seeds (one episode per task)
#SBATCH --cpus-per-task=16
#SBATCH --mem=16G
#SBATCH --time=4-00:00
#SBATCH --output=ind_sal_alpha8_entropy_threshold1e-3_%A_%a.out
...
mkdir -p "$CSV_DIR"
LOG_FILE="$SLURM_TMPDIR/ind_sal__alpha8_entropy_threshold1e-3_ep${EP_SEED}_a0_${A0_SEED}_a1_${A1_SEED}.log"
