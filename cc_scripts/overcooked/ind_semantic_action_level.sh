...
#SBATCH --job-name=aif_ind_sal_Bnoise05
#SBATCH --array=0-9                   # 10 seeds (one episode per task)
#SBATCH --cpus-per-task=12
#SBATCH --mem=8G
#SBATCH --time=4-00:00
#SBATCH --output=ind_sal_Bnoise05_%A_%a.out
...
mkdir -p "$CSV_DIR"
LOG_FILE="$SLURM_TMPDIR/ind_sal__Bnoise05_ep${EP_SEED}_a0_${A0_SEED}_a1_${A1_SEED}.log"
