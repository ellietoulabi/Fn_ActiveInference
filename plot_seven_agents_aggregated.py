"""
Plot aggregated comparison across multiple seeds for 7 agents.
...
def load_and_process_multiseed_log(log_file):
    ...
    if 'seed' not in df.columns:
        raise ValueError("Log file must contain 'seed' column. Use compare_seven_agents.py with multiple seeds.")
...
def main():
    parser = argparse.ArgumentParser(description='Plot aggregated multi-seed comparison (mean values) for 7 agents')
