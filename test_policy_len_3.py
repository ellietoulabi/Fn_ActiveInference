"""Test with policy_len=3 (realistic setting)."""
...
print(f"Test with policy_len=3, inference_horizon=3")
print(f"Number of policies: {6**3} = 216")
print("="*60)
...
print(f"Total: {(t_infer_states + t_infer_policies)*1000:.1f}ms")
print(f"\nPer policy: {t_infer_policies/216*1000:.1f}ms")
