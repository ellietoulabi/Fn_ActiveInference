...
agents.FullyCollectiveActiveInferenceWithDynamicPoliciesExact, whose
...
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesExact.agent import Agent as _BaseAgent
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesExact import control, inference
