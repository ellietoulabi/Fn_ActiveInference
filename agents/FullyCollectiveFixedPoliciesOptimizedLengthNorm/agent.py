...
agents.FullyCollectiveActiveInferenceWithDynamicPoliciesOptimizedLengthNorm,
...
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesOptimizedLengthNorm.agent import Agent as _BaseAgent
from agents.FullyCollectiveActiveInferenceWithDynamicPoliciesOptimizedLengthNorm import control, inference
